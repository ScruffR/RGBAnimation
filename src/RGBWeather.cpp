...
void RGBWeatherClass::draw()
{
  ...
  uint16_t        foreColor[3]  = { _d.Color333(7,7,7), _d.Color333(7,7,7), _d.Color333(7,7,7) };
  uint16_t        backColor     = _d.Color333(0,0,0); // black
  bool            precipitate   = false;
  uint16_t        precipColor   = _d.Color333(0,0,7); // blue
  char            text[8]       = "";
  uint16_t        textColor     = _d.Color333(7,7,7); // white
  ...
  switch(_w->code[_curFrame] / 100)
  {
      ...
      case 6: // 6xx Snow
        ...
        switch(intensity)
        {
          case 1:
          case 2:
            frameDelay = 30;                // snow falls slower
            break;
          case 3:
            frameDelay = 40;                // snow falls slower
            break;
          case 4:
            frameDelay = 50;                // snow falls slower
            break;
          default: 
            break;
        }
  ...
  if (millis() - msIncSubFrame > frameDelay)  
  {
  ...
  //print3x6(_pos.x + 16 - strlen(text)*3, _pos.y, text, textColor, _d.Color444(0,0,0));
  print3x6(_pos.x + 16 - strlen(text)*3 - 2, _pos.y    , text, _d.Color444(0,0,0));
  print3x6(_pos.x + 16 - strlen(text)*3    , _pos.y    , text, _d.Color444(0,0,0));
  print3x6(_pos.x + 16 - strlen(text)*3 - 1, _pos.y    , text, _d.Color444(9,0,0));
...
const uint8_t RGBWeatherClass::cloud[] PROGMEM = {
...
const uint8_t RGBWeatherClass::cloud_outline[] PROGMEM = {
	0b00000000,0b00000000 , 
	0b00000000,0b11100000 , 
...
const uint8_t RGBWeatherClass::small_sun[] PROGMEM= {
    0b00000000, 0b00000000, 
...
const uint8_t RGBWeatherClass::big_sun[] PROGMEM= {
...
const uint8_t RGBWeatherClass::lightning[] PROGMEM = {
    0b00000000, 0b00000000, 
    0b00000000, 0b00000000, 
    0b00000000, 0b00000000, 
    0b00000000, 0b00000000, 
...
const uint8_t RGBWeatherClass::fog[] PROGMEM = {
    0b00000000, 0b00000000, 
...
const uint8_t RGBWeatherClass::extreme[] PROGMEM = {
    0b00000000, 0b00000000, 
    0b00000000, 0b00000000, 
    0b00000000, 0b10000000, 
